...
class InstallCommand extends Command
{
    ...
    protected function configureUuids()
    {
        ...
        $this->replaceInFile(database_path('migrations/2016_06_01_000006_create_oauth_device_codes_table.php'), '$table->unsignedBigInteger(\'client_id\');', '$table->uuid(\'client_id\');');
